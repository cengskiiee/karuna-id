                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="page-header-box">
                            <h1 class="text-anime-style-3" data-cursor="-opaque">{{ __('header.education') }}</h1>
                            <nav class="wow fadeInUp">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('header.home') }}</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="#news-start">{{ __('header.education') }}</a></li>
                                </ol>
                            </nav>
                        </div>
                        <!-- Page Header Box End -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="section-title" style="text-align: center">
                <h3 class="wow fadeInUp">{{ __('general.all_education') }}</h3>
                <h2 class="text-anime-style-3" data-cursor="-opaque">{{ __('general.all_education_desc') }}</h2>
                <br>
            </div>
            <!-- Title End -->
